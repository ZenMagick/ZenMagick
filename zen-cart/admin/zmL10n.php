...
require_once(DIR_FS_CATALOG.'zenmagick/init.php'); 
  ...
  if (isset($_GET['theme']) && isset($_GET['download'])) {
      ...
      $map = zm_build_theme_l10n_map(DIR_FS_CATALOG."zenmagick/themes/" . $_GET['theme'], $defaults, $merge);
    ...
    <div id="main">
      <div id="content">
        ...
        <?php if ('' != $themePath) { ?>
          ...
          <?php $map = zm_build_theme_l10n_map(DIR_FS_CATALOG."zenmagick/themes/" . $themePath, $defaults, $merge) ?>
