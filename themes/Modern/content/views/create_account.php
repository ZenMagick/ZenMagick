...
<?php echo $form->open('create_account', '', true, array('id'=>'registration')) ?>
    <?php if ($settingsService->get('isPrivacyMessage')) { ?>
        <fieldset>
            ...
            <p>
                ...
                <?php $href = '<a href="' . $net->staticPage('privacy') . '">' . _vzm("here") . '</a>'; ?>
    ...
    <fieldset>
        ...
        <table cellspacing="0" cellpadding="0">
            <?php if ($settingsService->get('isAccountGender')) { ?>
                <tr>
                    <td class="label"><?php _vzm("Title") ?><span>*</span></td>
                    <td>
    ...
    <div class="btnwrapper"><input type="submit" class="btn" value="<?php _vzm("Create Account") ?>" /></div>
</form>
