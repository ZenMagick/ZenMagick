    ...
    <?php echo $form->open('shopping_cart', '', true) ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php $odd = true; $first = true; foreach ($shoppingCart->getItems() as $item) { ?>
                ...
                <td class="remove"><a href="<?php echo $net->generate('cart.remove', array('product_id' => $item->getId())) ?>"><img src="<?php echo $this->asUrl("resource:images/small_delete.gif") ?>" alt="remove" /></a></td>
                    <td class="img">
