...
<div>
  ...
  <p><?php _vzm('You can enter the Redemption Code during Checkout, after making your selections in the store. Or, you may redeem it now by following this link: <a href="%s">Redeem</a>', $net->url('gv_redeem', 'gv_no='.$newAccountGVAmountCoupon->getCode(), true)) ?></p>
