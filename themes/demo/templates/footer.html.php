...
<div id="footer">
    ...
    <p id="sview">
        <a href="<?php echo $net->url('source_view', array('layout_name' => $view->getLayout())) ?>">Layout: '<?php echo basename($view->getLayout()) ?>'</a>
        <a href="<?php echo $net->url('source_view', array('view_name' => $request->getRequestId())) ?>">View: '<?php echo basename($request->getRequestId()) ?>'</a>
    </p>
