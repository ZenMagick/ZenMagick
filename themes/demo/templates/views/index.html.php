...
<h2>Ajax</h2>
<ul>
  <li>The <a href="<?php echo $view['router']->generate('ajax_demo') ?>">Ajax demo page</a> shows a few Ajax things possible with ZenMagick.</li>
  <li>The <a href="<?php echo $view['router']->generate('ajax_demo2') ?>">New Shipping Estimator demo page</a> shows an Ajax based estimator using new shipping code.</li>
  <li>Drag/Drop Ajax cart demo in <a href="<?php echo $view['router']->generate('category', array('cPath' => 22)) ?>">category list pages</a>
...
<ul>
  ...
  <li><a href="http://wiki.zenmagick.org/index.php/Plugins::googleStoreLocator">Google Maps Store Locator</a> - there is a <a href="<?php echo $view['router']->generate('store_locator') ?>">demo</a> right here!</li>
  <li><a href="http://wiki.zenmagick.org/index.php/Plugins::zmpage_stats">Page Stats</a> - at the bottom of the page </li>
  <li><a href="http://wiki.zenmagick.org/index.php/Plugins::unitTests">Unit Tests</a> - check out this <a href="<?php echo $view['router']->generate('tests') ?>">demo version</a> </li>
</ul>
...
<ul>
  ...
  <li>A customized default controller to illustrate extending controller code; in this example, the crubtrail is modified. This affects
    all pages handled by the default controller, for example the <a href="<?php echo $view['router']->generate('site_map') ?>">sitemap</a>)</li>
  <li>Programmatical theme switching - the <a href="<?php echo $view['router']->generate('contact_us') ?>">contact us page</a> will always use the default theme</li>
