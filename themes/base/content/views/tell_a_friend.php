...
<?php $crumbtrail->addCategoryPath($request->getCategoryPathArray())->addManufacturer($request->query->getInt('manufacturers_id'))->addProduct($currentProduct->getId())->addCrumb(_zm('Tell A Friend')) ?>
