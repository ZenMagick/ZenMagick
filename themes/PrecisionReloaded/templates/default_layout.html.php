...
-->
  ...
  <body>
    ...
    <div id="pagebar">  <!-- insert page menu bar here  -->
      <div id="pagemenu">
        <?php echo $this->fetch('page_menu.html.php') ?>
      </div> <!-- end pagemenu  -->
    ...
    <div id ="colmask" class="threecol">
     ...
     <div id="footer">
       <p class="legal">
         &copy;2009-2012 All Rights Reserved - &nbsp;<strong>Your Web Store Site</strong>&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;| Powered by
         <strong><a href="http://www.zenmagick.org">ZenMagick</a></strong>
      </p>
