    ...
    <fieldset>
        ...
        <table cellspacing="5" cellpadding="2">
            ...
            <tbody>
               <!-- <?php if (ZMSettings::get('isAccountGender')) { ?>
                ...
                <!--<?php if (ZMSettings::get('isAccountDOB')) { ?>
                    <tr>
                        ...
                        <td><input type="text" name="dob" value="<?php echo $html->encode($registration->getDob()) ?>" /> <?php _vzm("Format: %s;&nbsp;(e.g: %s)", UI_DATE_FORMAT, UI_DATE_FORMAT_SAMPLE) ?></td>
                    </tr>
                <?php } ?> -->
                <tr>
               ...
               <!-- <tr>
                    <td><?php _vzm("PlaypenSuburb") ?></td>
                    <td><input type="text" name="suburb" value="<?php echo $html->encode($registration->getSuburb()) ?>" <?php echo $form->fieldLength(TABLE_ADDRESS_BOOK, 'entry_suburb') ?> align="left" /></td>
                </tr> -->
                <tr>
