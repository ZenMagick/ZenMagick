...
class Products extends ZMObject implements SqlAware
{
    ...
    protected function getAllProductsQueryDetails($active=true, $languageId)
    {
        ...
        return new QueryDetails(\ZMRuntime::getDatabase(), $sql, $args, array('products', 'specials', 'products_description'), 'ZenMagick\StoreBundle\Entity\Product', 'p.products_id');
    }
    ...
    protected function getProductsForCategoryIdQueryDetails($categoryId, $active, $languageId)
    {
        ...
        return new QueryDetails(\ZMRuntime::getDatabase(), $sql, $args, array('products', 'specials', 'products_description', 'products_to_categories'), 'ZenMagick\StoreBundle\Entity\Product', 'p.products_id');
    }
    ...
    public function getProductForModel($model, $languageId)
    {
        ...
        $product = \ZMRuntime::getDatabase()->querySingle($sql, $args, array('products', 'products_description', 'specials'), 'ZenMagick\StoreBundle\Entity\Product');
    ...
    public function getProductsForIds($productIds, $preserveOrder=false, $languageId=null)
    {
        ...
        if (0 < count($needLoadIds)) {
            ...
            $results = \ZMRuntime::getDatabase()->fetchAll($sql, $args, array('products', 'products_description', 'specials'), 'ZenMagick\StoreBundle\Entity\Product');
