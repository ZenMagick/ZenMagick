...
<div id="widget-box">
  <div id="grid-list" class="ui-corner-all">
    <a href="#" class="db-grid-selector" id="col2"><img src="<?php echo $view['assets']->getUrl('bundles/admin/images/icons/col2.png') ?>" alt="<?php _vzm('two column') ?>" title="<?php _vzm('two column') ?>"></a>
    <a href="#" class="db-grid-selector" id="col2l"><img src="<?php echo $view['assets']->getUrl('bundles/admin/images/icons/col2l.png') ?>" alt="<?php _vzm('two column - large right') ?>" title="<?php _vzm('two column - large right') ?>"></a>
    <a href="#" class="db-grid-selector" id="col2r"><img src="<?php echo $view['assets']->getUrl('bundles/admin/images/icons/col2r.png') ?>" alt="<?php _vzm('two column - large left') ?>" title="<?php _vzm('two column - large left') ?>"></a>
    <a href="#" class="db-grid-selector" id="col3"><img src="<?php echo $view['assets']->getUrl('bundles/admin/images/icons/col3.png') ?>" alt="<?php _vzm('three column') ?>" title="<?php _vzm('three column') ?>"></a>
  </div>
