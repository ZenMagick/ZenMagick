...
class ZenMagickExtension extends Extension
{
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $files = array();
        $files[] = 'src/ZenMagick/ZenMagickBundle/Resources/config/base.xml';
        $files[] = 'src/ZenMagick/ZenMagickBundle/Resources/config/http.xml';
        if ($config['plugins']['enabled']) {
            $files[] = 'src/ZenMagick/ZenMagickBundle/Resources/config/plugins.xml';
        }
