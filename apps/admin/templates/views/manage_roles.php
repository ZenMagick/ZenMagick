...
<form action="<?php echo $admin->url() ?>" method="POST" id="manage-roles-form">
  <fieldset>
    <p>
...
<form action="<?php echo $admin->url() ?>" method="POST" id="add-role-form">
  <fieldset>
...
$('#edit-role').click(function() {
  ...
  if (0 < roles.length) {
      var role = roles.pop();
      ZenMagick.ajaxFormDialog('<?php echo $admin->url('edit_role') ?>&role='+role, {title:'<?php echo _zm('Edit role permissions: ') ?>'+role, formId: 'ajax-form'});
  }
  return false;
});
</script>
