...
class AdminUserService extends ZMObject {
    ...
    public function getUserForId($id) {
        $sql = "SELECT *
                ...
                WHERE admin_id = :id";
        $args = array('id' => $id);
        return $this->finalizeUser(\ZMRuntime::getDatabase()->querySingle($sql, $args, TABLE_ADMIN, 'zenmagick\apps\admin\entities\AdminUser'));
    }
    ...
    public function getAllUsers($demoOnly=false) {
        ...
        $users = array();
        foreach (\ZMRuntime::getDatabase()->query($sql, array('live' => false), TABLE_ADMIN, 'zenmagick\apps\admin\entities\AdminUser') as $adminUser) {
