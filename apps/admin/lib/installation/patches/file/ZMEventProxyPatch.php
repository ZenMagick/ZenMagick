        ...
        if (is_writeable(_ZM_ZEN_BASE_PHP)) {
            ...
            foreach ($lines as $line) {
                ...
                if (false !== strpos($line, "function notify(")) {
                    ...
                    array_push($patchedLines, '    if(class_exists("zenmagick\\\base\\\Runtime")) { zenmagick\\base\\Runtime::getEventDispatcher()->notify(new zenmagick\\base\\events\\Event($this, strtolower($eventID), $paramArray)); } /* added by ZenMagick installation patcher */');
                }
            }
