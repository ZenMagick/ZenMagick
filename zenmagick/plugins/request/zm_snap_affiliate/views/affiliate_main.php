...
<?php if ($affiliateDetails->referrer_banned) { ?>
    ...
    <a href="<?php echo $net->url('contact_us') ?>">contact us</a>.</em>
<?php } ?>

<p>Orders and Payments | <a href="<?php echo $net->url('affiliate_tools', '', true) ?>">Marketing Tools</a> | 
  <a href="<?php echo $net->url('affiliate_terms', '', false) ?>">Referrer Terms</a></p>
