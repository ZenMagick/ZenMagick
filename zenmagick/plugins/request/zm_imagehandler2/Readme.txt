...
b) Add the following two lines to the <head> element of the used layout file(s):
    ...
    <link rel="stylesheet" type="text/css" media="screen,projection" href="<?php $zm_theme->themeURL("style_imagehover.css") ?>" />
    <script type="text/javascript" src="<?php $zm_theme->themeURL("jscript_imagehover.js") ?>"></script>
