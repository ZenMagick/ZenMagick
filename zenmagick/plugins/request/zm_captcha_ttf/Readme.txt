...
2) dded a new line in the c'tor to set the fonts directory. That line needs
...
an example for the contact_us page:
    ...
    <?php if (is_object($zm_captcha_ttf) && $zm_captcha_ttf->isCaptchaEnabled()) { ?>
        ...
        <a href="<?php zm_href(FILENAME_CONTACT_US) ?>"><?php zm_l10n("Click to create new image")?></a><br />
