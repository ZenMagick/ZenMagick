...
class zm_captcha extends Plugin {
    ...
    function install() {
        parent::install();
        ZMDbUtils::executePatch(file(ZMDbUtils::resolveSQLFilename($this->getPluginDirectory()."install.sql")), $this->messages_);
    }
    ...
    function remove($keepSettings=false) {
        ...
        ZMDbUtils::executePatch(file(ZMDbUtils::resolveSQLFilename($this->getPluginDirectory()."uninstall.sql")), $this->messages_);
    }
