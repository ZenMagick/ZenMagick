...
class TestBrowsing extends ZMWebTestCase {
    ...
    public function testHome() {
        $this->get($this->getRequest()->getToolbox()->net->url(FILENAME_DEFAULT, '', false, false), array('themeId' => 'default'));
    ...
    public function testProduct() {
        $this->get($this->getRequest()->getToolbox()->net->url(FILENAME_PRODUCT_INFO, '', false, false), array('products_id' => '19', 'themeId' => 'default'));
        $this->assertResponse(200);
