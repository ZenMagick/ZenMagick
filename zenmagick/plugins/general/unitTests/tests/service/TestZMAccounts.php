 ...
 * @author DerManoMann
 * @version $Id: TestZMAccounts.php 2508 2009-09-12 15:00:51Z dermanomann $
 */
class TestZMAccounts extends ZMTestCase {
    ...
    protected $accountData1 = array(
            ...
            'Type' => ZMZenCartUserSacsHandler::REGISTERED,
            'PriceGroupId' => 0,
    );
