        ...
        foreach ($fktFilesCfg as $file => $fktCfgs) {
            ...
            if ($fileNeedsPatch) {
                if (is_writeable($file)) {
                    ...
                    $this->log("** ZenMagick: no permission to patch ".basename($file), ZM_LOG_ERROR);
                    $patchOk = false;
                }
            }
        }
        ...
        foreach ($fktFilesCfg as $file => $fktCfgs) {
            ...
            if ($fileNeedsUndo) {
                if (is_writeable($file)) {
                    ...
                    $this->log("** ZenMagick: no permission to patch ".basename($file)." for uninstall", ZM_LOG_ERROR);
                    $undoOk = false;
                }
            }
        }
