...
class ZMNoThemeSupportPatch extends ZMFilePatch {
    ...
    function patch($force=false) {
        ...
        $PATCHLINE = "if (!ZMSettings::get('isEnableZMThemes')) { echo ZMPlugins::filterResponse(ob_get_clean()); ZMRequest::getSession()->clearMessages(); ZMEvents::instance()->fireEvent(null, ZMEvents::ALL_DONE); } /* added by ZenMagick installation patcher */";
