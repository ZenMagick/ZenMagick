 ...
 * @version $Id$
 */
class ZMCatalogPlugin extends ZMPlugin {
     ...
     * @param string version The version.
     */
    function ZMCatalogPlugin($title='', $description='', $version='0.0') {
    ...
    function addMenuItem($id, $title, $function) {
        zm_add_menu_item(new ZMMenuItem('catalog_plugins', $id, $title, null, $function));
    }
