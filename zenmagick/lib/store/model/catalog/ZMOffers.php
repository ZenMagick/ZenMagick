...
class ZMOffers extends ZMObject {
    ...
    protected function doGetSalePrice() {
        ...
        $results = Runtime::getDatabase()->query($sql, $args, TABLE_SALEMAKER_SALES);
    ...
    public function getQuantityDiscounts($tax=true) {
        ...
        $this->discounts_ = Runtime::getDatabase()->query($sql, $args, TABLE_PRODUCTS_DISCOUNT_QUANTITY, 'QuantityDiscount');
    ...
    public function calculateDiscount($amount=null) {
        ...
        $typeInfo = ZMSalemaker::instance()->getSaleDiscountTypeInfo($this->product_->getId());
