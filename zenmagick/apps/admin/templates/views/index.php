...
<h1><?php _vzm('Dashboard') ?><a href="" title="<?php _vzm('Customize Dashboard') ?>" onclick="$('#widget-box').dialog({width:500,title:'<?php _vzm('Widget Box') ?>'});return false;"><span class="ui-icon ui-icon-wrench"></span></a></h1>
