...
<form action="<?php echo $toolbox->admin2->url() ?>" method="POST">
  <fieldset>
...
<?php if ('' != $themePath) { ?>
  <a href="<?php echo $toolbox->admin2->url(null, 'theme='.$themePath.'&download=full'.($merge?"&amp;merge=true":"")) ?>">Download mapping</a>
