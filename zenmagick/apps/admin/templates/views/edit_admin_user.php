...
<form action="<?php echo $admin2->url() ?>" method="POST">
  ...
  <fieldset>
    <p><label for="name">Name</label> <input type="text" id="name" name="name" value="<?php echo $html->encode($adminUser->getName()) ?>"></p>
    <p><label for="email">Email</label> <input type="text" id="email" name="email" value="<?php echo $html->encode($adminUser->getEmail()) ?>"></p>
    <p>
  ...
  <p>
    <input type="submit" value="<?php zm_l10n((0 < $adminUser->getAdminUserId()) ? "Update" : "Create") ?>">
    <a href="<?php echo $admin2->url('admin_users') ?>">Cancel</a>
  </p>
</form>
