  ...
  <body>
    ...
    <div id="header-wrap"><div id="header" class="container_16">						
      ...
      <?php $form->open('search', '', false, array('method' => 'get', 'id' => 'quick-search')) ?>
        ...
        <input class="tbox" id="qsearch" type="text" name="keywords" value="<?php $html->encode(ZMRequest::getParameter('keywords', KEYWORD_DEFAULT)) ?>" onfocus="<?php echo $onfocus ?>" title="Start typing and hit ENTER" />
