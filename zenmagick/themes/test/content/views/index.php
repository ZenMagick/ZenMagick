...
<div id="featured"> 
  <?php foreach ($featured as $product) { ?> 
    <div><table class="tbl" width="100%" height="125"> 
      ...
      <tr height="38" wid><td width="100%" valign="top"><font class="product"><a href="<?php $net->product($product->getId()) ?>"><?php echo $html->more($html->strip($product->getName()), 40) ?></a></font></td></tr> 
