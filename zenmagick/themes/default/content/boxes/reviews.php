...
<?php 
    ...
    $reviews = ZMReviews::instance()->getRandomReviews(ZMRequest::getProductId(), 1, $session->getLanguageId()); 
...
<?php if (1 == count($reviews)) {
    ...
    ?>
    <h3><a href="<?php $net->url(FILENAME_REVIEWS) ?>"><?php zm_l10n("[More]") ?></a><?php zm_l10n("Reviews") ?></h3>
