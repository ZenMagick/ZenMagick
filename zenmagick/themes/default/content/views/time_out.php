...
<p><?php zm_l10n('If you had completed an order and wish to review it, or had a download and wish to retrieve it, please go to your <a href="%s">My Account</a> page to view your order.', $_t->net->url(FILENAME_ACCOUNT, '', true, false)) ?></p>
