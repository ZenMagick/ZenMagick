...
<?php if (0 < count($zm_addressList)) { ?>
    <?php $form->open(FILENAME_CHECKOUT_PAYMENT_ADDRESS, 'action=submit', true, array('id'=>'existing_address')) ?>
...
<?php } ?>
<?php $form->open(FILENAME_CHECKOUT_PAYMENT_ADDRESS, 'action=submit', true, array('id'=>'address', 'onsubmit'=>'return validate(this);')) ?>
