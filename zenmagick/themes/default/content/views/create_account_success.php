...
<?php $email = '<a href="' . $net->url(FILENAME_CONTACT_US, '', false, false) . '">' . zm_l10n_get("store owner") . '</a>'; ?>
<?php $contactus = '<a href="' . $net->url(FILENAME_CONTACT_US, '', false, false) . '">' . zm_l10n_get("contact us") . '</a>'; ?>
