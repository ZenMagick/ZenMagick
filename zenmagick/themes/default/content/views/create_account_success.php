...
<?php $email = '<a href="' . $request->url(FILENAME_CONTACT_US) . '">' . zm_l10n_get("store owner") . '</a>'; ?>
<?php $contactus = '<a href="' . $request->url(FILENAME_CONTACT_US) . '">' . zm_l10n_get("contact us") . '</a>'; ?>
