...
<?php zm_l10n("To view the product, click on the following link or copy and paste the link into your web browser: %s", $net->product($zm_product->getId(), null, false)) ?>
