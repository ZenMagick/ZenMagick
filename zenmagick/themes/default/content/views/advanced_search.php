...
<?php zm_form(FILENAME_ADVANCED_SEARCH_RESULT, '', 'advanced_search', "get", "return validate(this);") ?>
    ...
    <fieldset id="asfilter">
        ...
        <fieldset>
            ...
            <?php zm_idp_select('categories_id', array_merge(array(new ZMIdNamePair("", zm_l10n_get("All Categories"))), $categories), 1, $zm_search->getCategory()) ?>
        ...
        <fieldset>
            ...
            <?php zm_idp_select('manufacturers_id', array_merge(array(new ZMIdNamePair("", zm_l10n_get("All Manufacturers"))), $manufacturers), 1, $zm_search->getManufacturer()) ?>
        </fieldset>
