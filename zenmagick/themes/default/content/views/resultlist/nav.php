...
<?php if (1 < $zm_resultList->getNumberOfPages()) { ?>
    <div class="rnav">
        ...
        <?php if ($zm_resultList->hasPreviousPage()) { ?>
            <a href="<?php $zm_resultList->getPreviousURL(ZMRequest::isSecure()) ?>"><?php zm_l10n("Previous") ?></a>&nbsp;
        <?php } else { ?>
            <span class="nin"><?php zm_l10n("Previous") ?></span>&nbsp;
        <?php } ?>
        <?php if ($zm_resultList->hasNextPage()) { ?>
            <a href="<?php $zm_resultList->getNextURL(ZMRequest::isSecure()) ?>"><?php zm_l10n("Next") ?></a>
        <?php } else { ?>
