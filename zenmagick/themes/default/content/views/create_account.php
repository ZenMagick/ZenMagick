        ...
        <table cellspacing="0" cellpadding="0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="text" name="street_address" value="<?php $_t->html->encode($zm_address->getAddress()) ?>" <?php zm_field_length(TABLE_ADDRESS_BOOK, 'entry_street_address') ?> /></td>
                </tr>
                <tr>
                    <td><?php zm_l10n("Suburb") ?></td>
                    <td><input type="text" name="suburb" value="<?php $_t->html->encode($zm_address->getSuburb()) ?>" <?php zm_field_length(TABLE_ADDRESS_BOOK, 'entry_suburb') ?> /></td>
                </tr>
                <tr>
                    <td><?php zm_l10n("City") ?><span>*</span></td>
                    <td><input type="text" name="city" value="<?php $_t->html->encode($zm_address->getCity()) ?>" <?php zm_field_length(TABLE_ADDRESS_BOOK, 'entry_city') ?> /></td>
                </tr>
                <?php 
                ...
                <tr>
                    ...
                    <td><input type="text" name="postcode" value="<?php $_t->html->encode($zm_address->getPostcode()) ?>" <?php zm_field_length(TABLE_ADDRESS_BOOK, 'entry_postcode') ?> /></td>
                </tr>
                 <tr>
