...
<ul>
    <?php if ($request->isRegistered()) { ?>
      ...
      <ul>
        ...
        <li><a href="<?php echo $net->url(FILENAME_ACCOUNT_HISTORY, '', true) ?>"><?php zm_l10n("Order History") ?></a></li>
        ...
        <?php if (!$request->getShoppingCart()->isEmpty()) { ?>
            <li><a href="<?php echo $net->url(FILENAME_SHOPPING_CART, '', true); ?>"><?php zm_l10n("Shopping cart") ?></a></li>
            <li><a href="<?php echo $net->url(FILENAME_CHECKOUT_SHIPPING, '', true); ?>"><?php zm_l10n("Checkout") ?></a></li>
        <?php } ?>
    <?php } ?>
    <li><a href="<?php echo $net->url(FILENAME_ADVANCED_SEARCH); ?>"><?php zm_l10n("Advanced Search") ?></a></li>
    ...
    <li><a href="<?php echo $net->url(FILENAME_REVIEWS); ?>"><?php zm_l10n("Reviews") ?></a></li>
    <li><?php zm_l10n("Information") ?>
        <ul>
          <li><a href="<?php echo $net->url(FILENAME_SHIPPING); ?>"><?php zm_l10n("Shipping Information") ?></a></li>
          <li><a href="<?php echo $net->url(FILENAME_PRIVACY); ?>"><?php zm_l10n("Privacy Policy") ?></a></li>
          <li><a href="<?php echo $net->url(FILENAME_CONDITIONS); ?>"><?php zm_l10n("Terms &amp; Conditions") ?></a></li>
          <li><a href="<?php echo $net->url(FILENAME_CONTACT_US); ?>"><?php zm_l10n("Contact Us") ?></a></li>

      <?php if (ZMSettings::get('isEnabledGV')) { ?>
          <li><a href="<?php echo $net->url(FILENAME_GV_FAQ); ?>"><?php zm_l10n("Giftvoucher FAQ") ?></a></li>
      <?php } ?>
      <?php if (ZMSettings::get('isEnabledCoupons')) { ?>
          <li><a href="<?php echo $net->url(FILENAME_DISCOUNT_COUPON); ?>"><?php zm_l10n("Coupon Lookup") ?></a></li>
      <?php } ?>
      <li><a href="<?php echo $net->url(FILENAME_UNSUBSCRIBE); ?>"><?php zm_l10n("Newsletter Unsubscribe") ?></a></li>
   </ul></li>
</ul>
