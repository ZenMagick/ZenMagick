...
<div id="footer">
    ...
    <p id="sview">
        <a href="<?php $net->url('source_view', 'template_name='.$this->getLayout()) ?>">Template: '<?php echo basename($this->getLayout()) ?>'</a>
        <a href="<?php $net->url('source_view', 'view_name='.$this->getName()) ?>">View: '<?php echo basename($this->getName()) ?>'</a>
    </p>
