...
<div id="footer">
    ...
    <p id="sview">
        <a href="<?php $net->url('source_view', 'template_name='.$view->getLayout()) ?>">Template: '<?php echo basename($view->getLayout()) ?>'</a>
        <a href="<?php $net->url('source_view', 'view_name='.$request->getRequestId()) ?>">View: '<?php echo basename($request->getRequestId()) ?>'</a>
    </p>
