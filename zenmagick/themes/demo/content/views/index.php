...
<ul>
  <li>The <a href="<?php $net->url('ajax_demo') ?>">Ajax demo page</a> - Simple code that uses the ZenMagick Ajax controllers</li>
  ...
  <li>The <code>extra/controller</code> folder contains a few custom controller that change the default ZenMagick behaviour or extend it; for example:
    <ul>
      ...
      <li>Custom default controller that modifies the crumbtrail of all affected pages (for example, the <a href="<?php $net->url(FILENAME_SITE_MAP) ?>">sitemap</a>)</li>
    </ul>
  </li>
