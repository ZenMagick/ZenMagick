...
<?php zm_add_product_form($zm_product->getId()) ?>
  ...
  <?php 
      ...
      $music = $zm_loader->newInstance("Music");
      $artist = $music->getArtistForProductId($zm_product->getId());

      $mediaManager = new ZMMediaManager();
      $collections = $mediaManager->getMediaCollectionsForProductId($zm_product->getId());
  ?>
  <fieldset>
