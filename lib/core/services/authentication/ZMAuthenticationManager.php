...
class ZMAuthenticationManager extends ZMObject {
    ...
    function __construct() {
        ...
        $this->addProvider(Runtime::getSettings()->get('zenmagick.core.security.defaultAuthenticationProvider', 'ZMSha1Authentication'), true);
    }
    ...
    public function mkPassword() {
        return ZMSecurityUtils::random(ZMSettings::get('zenmagick.core.authentication.minPasswordLength', 8), ZMSecurityUtils::RANDOM_MIXED);
    }
