...
/**
 * Packer for the <em>sfYaml</em> library.
 *
 * @author DerManoMann
 * @package org.zenmagick.core.build
 */
class ZMSfYamlPacker extends ZMPhpPackagePacker implements ZMLibraryPacker {

    /**
     * {@inheritDoc}
     */
    public function process($sourceDir, $targetDir, $version, $strip) {
        $this->rootFolder_ = $sourceDir.'lib'.DIRECTORY_SEPARATOR;
