...
if ($needRefresh) {
    return new RedirectResponse($net->generate('installation'));
}
...
<h2><?php _vzm("ZenMagick Installation") ?> <a class="btn" href="<?php echo $net->generate('installation') ?>"><?php _vzm("Refresh Page") ?></a></h2>

<form action="<?php echo $net->generate('installation') ?>" method="POST" onsubmit="return ZenMagick.confirm('Update File Patches?', this);">
  ...
  <form action="<?php echo $net->generate('installation') ?>" method="POST" onsubmit="return ZenMagick.confirm('Update SQL Patches?', this);">
    <fieldset class="patches">
  ...
  <form action="<?php echo $net->generate('installation') ?>" method="POST" onsubmit="return ZenMagick.confirm('Load static page content as EZPage?\n(This will override EZPages if an EZPage with a matching title already exists)', this);">
  ...
  <form action="<?php echo $net->generate('installation') ?>" method="POST" onsubmit="return ZenMagick.confirm('Update selected optimisations?\n(This might take a while...)', this);">
