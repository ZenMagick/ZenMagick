...
<form action="<?php echo $view['router']->generate('theme_builder') ?>" method="POST" onsubmit="return ZenMagick.confirm('_vzm('Create theme?')', this);">
  <fieldset>
...
<?php $link = '<a href="'.$view['router']->generate('installation').'">'._zm('installation').'</a>'; ?>
