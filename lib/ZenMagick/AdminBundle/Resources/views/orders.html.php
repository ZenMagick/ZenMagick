...
<table class="grid">
  ...
  <?php foreach ($resultList->getResults() as $order) { ?>
    <tr>
      <td><a href="<?php echo $net->url('order', array('orderId' => $order->getId())) ?>"><?php echo $order->getId() ?></a></td>
      ...
      <td><a href="<?php echo $net->url('account_show', array('accountId' => $order->getAccountId())) ?>"><?php echo $name ?></a></td>
