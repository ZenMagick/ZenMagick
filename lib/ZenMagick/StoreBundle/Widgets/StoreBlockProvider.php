...
class StoreBlockProvider extends ZMObject implements BlockProvider
{
    ...
    public function getBlockList($args=array())
    {
        ...
        // banners
        $blocks['bannerBlockWidget'] = 'ZenMagick\StoreBundle\Widgets\BannerBlockWidget';

        // paypal ec button
        $blocks['payPalECButtonBlockWidget'] = 'ZenMagick\StoreBundle\Widgets\PayPalECButtonBlockWidget';
