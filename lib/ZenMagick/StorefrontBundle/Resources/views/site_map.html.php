...
<ul>
    <?php if ($session->isRegistered()) { ?>
      ...
      <ul>
        ...
        <li><a href="<?php echo $view['router']->generate('account_history') ?>"><?php _vzm("Order History") ?></a></li>
        ...
        <?php } ?>
    <?php } ?>
    <li><a href="<?php echo $view['router']->generate('advanced_search'); ?>"><?php _vzm("Advanced Search") ?></a></li>
    <li><a href="<?php echo $view['router']->generate('products_new'); ?>"><?php _vzm("New Products") ?></a></li>
    <li><a href="<?php echo $view['router']->generate('specials'); ?>"><?php _vzm("Specials") ?></a></li>
    <li><a href="<?php echo $view['router']->generate('reviews'); ?>"><?php _vzm("Reviews") ?></a></li>
    <li><?php _vzm("Information") ?>
        <ul>
          <li><a href="<?php echo $view['router']->generate('shippinginfo'); ?>"><?php _vzm("Shipping Information") ?></a></li>
          <li><a href="<?php echo $view['router']->generate('privacy'); ?>"><?php _vzm("Privacy Policy") ?></a></li>
