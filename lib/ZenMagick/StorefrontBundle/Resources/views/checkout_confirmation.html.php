...
<fieldset>
    ...
    <?php if ($shoppingCart->hasShippingAddress()) { ?>
        <div class="oadr">
            <div class="btn"><a class="btn" href="<?php echo $net->generate('checkout_shipping_address') ?>"><?php _vzm("Change") ?></a></div>
    ...
    <?php } ?>
    <div class="oadr snd">
        <div class="btn"><a class="btn" href="<?php echo $net->generate('checkout_payment_address') ?>"><?php _vzm("Change") ?></a></div>
