...
<?php _vzm("More details can be found at the following URL: %s", $net->absoluteUrl($net->url('account_history_info', 'order_id='.$currentOrder->getId()), true), true, true) ?>
<?php } else { ?>
<?php _vzm("You can check the status of your order at: %s.", $net->absoluteUrl($net->url('guest_history', '', true), true, true)) ?>
<?php } ?>
