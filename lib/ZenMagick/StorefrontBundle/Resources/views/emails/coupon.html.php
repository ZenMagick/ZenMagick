...
<head>
<title><?php _vzm("A coupon from %s", $view['settings']->get('storeName')) ?></title>
</head>
<body>
<body>
...
<p><?php _vzm("We're pleased to offer you a Store Coupon for our online store at %s", $view['settings']->get('storeName')) ?></p>
