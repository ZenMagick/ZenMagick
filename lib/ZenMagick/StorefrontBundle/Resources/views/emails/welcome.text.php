...
<?php _vzm('You can enter the Redemption Code during Checkout, after making your selections in the store. Or, you may redeem it now by following this link: %s', $net->absoluteUrl($net->url('gv_redeem', 'gv_no='.$newAccountGVAmountCoupon->getCode()), true, true)) ?>
