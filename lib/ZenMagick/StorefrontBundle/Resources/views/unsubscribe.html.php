...
<?php if ($view['settings']->get('isAllowAnonymousUnsubscribe')) { ?>
...
<?php } else { ?>
      <div class="btn"><a href="<?php echo $view['router']->generate('account_newsletters') ?>" class="btn"><?php _vzm("Unsubscribe") ?></a></div>
<?php } ?>
