...
class ZMHowDidYouHearPlugin extends Plugin {
    ...
    function __construct() {
        parent::__construct('How did you hear about us', 'Adds a drop down to the register page asking: "How did you hear about us"');
    ...
    public function onZMInitDone($args=null) {
        if ($this->isRequired()) {
            ...
            $rules = array(
                array("RequiredRule", 'source', 'Please select/provide the source where you first heard about us.'),
                array("SourceOtherRule", 'source_other', 'Please provide a description about where you first heard about us.')
            );
