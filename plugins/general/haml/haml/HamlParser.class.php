...
class HamlParser
{
	 ...
	 * @return string
	 */
	public function parseFile($aSource)
	{
	 ...
	 * @return string
	 */
	public function indent($sLine, $iAdd = 0, $bNew = true)
	{
		$aLine = explode("\n", $sLine);
		$sIndented = '';
	 ...
	 * @return string
	 */
	public function sourceIndent($sSource, $iLevel)
	{
	 ...
	 * @return integer
	 */
	public function countLevel($sLine)
	{
	 ...
	 */
	public function parseSquareBrackets($mVariable)
	{
