...
class TestZMLocaleUtils extends ZMTestCase {
    ...
    public function testSimple() {
        ...
        if ($this->assertTrue(2 == count($map))) {
            $this->assertEqual(array('Bar' => array('msg' => 'Bar', 'plural' => null, 'context' => null, 'filename' => 'l10n-simple\sub\l10n-test2.phpx', 'line' => 3)), array_pop($map));
    ...
    public function testMixed() {
        ...
        if ($this->assertTrue(1 == count($map))) {
            $expected = array(
              ...
              'Bar' =>  array('msg' => 'Bar', 'plural' => null, 'context' => null, 'filename' => 'l10n-mixed\l10n-test1.phpx', 'line' => 6),
