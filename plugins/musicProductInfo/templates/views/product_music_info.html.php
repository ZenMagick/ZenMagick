          ...
          <?php foreach ($collections as $collection) { ?>
              <div class="mcol">
                  ...
                  <ul>
                      ...
                      <li><a href="<?php echo $view['assets']->getUrl($musicProductInfo->mediaUrl($mediaItem->getFilename())) ?>"><?php echo $media->getFilename() ?></a> (<?php echo $type->getName() ?>)</li>
                      <?php } ?>
                  </ul>
              </div>
          <?php } ?>
  ...
  <?php if ($currentProduct->hasReviews() || $currentProduct->getTypeSetting('reviews')) { ?>
      <fieldset>
          ...
          <?php if ($currentProduct->hasReviews()) { ?>
              <a class="btn" href="<?php echo $view['router']->generate('product_reviews', array('productId' => $currentProduct->getId())) ?>"><?php _vzm("Read Reviews") ?></a>
          <?php } ?>
