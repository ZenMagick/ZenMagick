 ...
 */ if (0 < count($themeList)) { ?>
  <div id="theme-switcher" style="text-align:right;padding:2px 8px;position:absolute;top:3px;right:4px;color:black;background-color:#abc;text-align:left;border:1px solid #ddd;border-radius:.5em;">
    <label for="selected-theme"><?php _vzm('Themes:') ?> </label><br>
