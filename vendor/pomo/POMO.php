...
<?php /* ../build/tmp/zenmagick/vendor/pomo//POMO.php.prep\\entry.php */ ?>
<?php namespace pomo; class POMO {} ?>
<?php
/**
...
<?php /* ../build/tmp/zenmagick/vendor/pomo//POMO.php.prep\\streams.php */ ?>
<?php
/**
...
<?php /* ../build/tmp/zenmagick/vendor/pomo//POMO.php.prep\\translations.php */ ?>
<?php
/**
...
class NOOP_Translations {
 ...
 /* .tmp\flat\1\mo.php */ ?>
<?php /* ../build/tmp/zenmagick/vendor/pomo//POMO.php.prep\\1\mo.php */ ?>
<?php
/**
...
class MO extends Gettext_Translations {
	...
	function import_from_reader($reader) {
		...
		for ( $i = 0; $i < $total; $i++ ) {
			...
			if ('' === $original) {
				$ph = $this->make_headers($translation);
				$this->set_headers($ph);
			} else {
 ...
 /* .tmp\flat\1\po.php */ ?>
<?php /* ../build/tmp/zenmagick/vendor/pomo//POMO.php.prep\\1\po.php */ ?>
<?php
/**
	...
	function import_from_file($filename) {
		...
		while (true) {
			...
			if ($res['entry']->singular == '') {
				$ph = $this->make_headers($res['entry']->translations[0]);
				$this->set_headers($ph);
			} else {
